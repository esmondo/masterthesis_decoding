function [predictions,predictionsSTF,alg1,alg2] = decode_meg_LDA(Xmeg,Y,Z,N,navg,nreps,meg)
            ...
            for r = 1:nreps % repetitions            
                ...
                %% Validation Dataset
                    for c = 1:length(testIdx)
                        ...
                        alg1 = train_LDA_classifier(Xtrain,Ytrain); % involves feature extraction and C calculation
                ...
                %% applying STF
                    ...
                    alg2 = train_LDA_classifier(filtDataTrain,Ytrain); % involves feature extraction and C calculation 
